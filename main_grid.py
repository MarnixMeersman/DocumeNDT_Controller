'''Developed by M.F.L. Meersman as part of his internship at CSIC
Last changes made on Nov 14, 2022. Madrid Spain'''
...
# TODO: Make sure portname is adjusted accordingly!!!!
...
app.layout = html.Div([
    html.Div(children=[
        ...
        html.Div(children=[
            ...
            dbc.Input(id='x-offset', type='number', value=0.5, min=0, max=0.5, step=0.01),
            html.Div(id='output-x-offset'),

            html.Label('Enter height (Y) [m] of the work area:'),
            dbc.Input(id='y-offset', type='number', value=0.98, min=0, max=0.98, step=0.01),
...
def mesh_grid(res_x, res_y, width, height):
    w_cnc = 0.50
    h_cnc = 0.98
    ...
    fig2 = go.Figure(
        go.Scatter(x=[0, w, w, 0, 0], y=[0, 0, h, h, 0],
                   fill="tonext"))
    # fig3 = go.Figure(
    ...
    #     dict(
    #         source="https://www.itefi.csic.es/sites/default/files/g-carma/documeNDT1_Logo.png",
    #         # xref="x",
    #         # yref="y",
    #         # x=0,
    #         # y=0,
